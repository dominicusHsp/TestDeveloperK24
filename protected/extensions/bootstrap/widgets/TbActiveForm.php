...
Yii::import('ext.bootstrap.widgets.input.TbInput');
...
class TbActiveForm extends CActiveForm
{
	...
	// Input classes.
	const INPUT_HORIZONTAL = 'ext.bootstrap.widgets.input.TbInputHorizontal';
	const INPUT_INLINE = 'ext.bootstrap.widgets.input.TbInputInline';
	const INPUT_SEARCH = 'ext.bootstrap.widgets.input.TbInputSearch';
	const INPUT_VERTICAL = 'ext.bootstrap.widgets.input.TbInputVertical';
